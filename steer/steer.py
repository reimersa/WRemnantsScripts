...
def main():
    ...
    corrs_and_postfixes_and_legendnames = [
        ...
        # DO NOT RUN HISTMAKER FOR THESE, N2+1LL was fixed to now be N3+1LL ("scetlib_dyturboN3p1LL", "N2LO_FixedAlphaS", "N$^{2{+}1}$LL+NNLO"), # (no smth.) 
        # DO NOT RUN HISTMAKER FOR THESE, N2+1LL was fixed to now be N3+1LL ("scetlib_nnlojet_N3p1LLN3LOUnsmoothed_N3pLLFixed", "FixedAlphaS", "N$^{2{+}1}$LL+N$^{3}$LO"), # (no smth.)
        # ("scetlib_dyturbo_N3p1LLN2LOUnsmoothed_N3pLLFixed_N2p1LLFixed", "FixedAlphaS", "N$^{3{+}1}$LL+NNLO"), # (no smth.)
        # ("scetlib_nnlojet_N3p1LLN3LOUnsmoothed_N3pLLFixed_N2p1LLFixed", "FixedAlphaS", "N$^{3{+}1}$LL+N$^{3}$LO"), # (no smth.)
        # ("scetlib_dyturbo_N4p0LLN2LOUnsmoothed_N3pLLFixed", "FixedAlphaS", "N$^{4{+}0}$LL+NNLO"), # (no smth.)
        # ("scetlib_nnlojet_N4p0LLN3LOUnsmoothed_N3pLLFixed", "FixedAlphaS", "N$^{4{+}0}$LL+N$^{3}$LO"), # (no smth.)

        # Kenneth's SCETlib files used to make as variations from N4LL
        # ("scetlib_dyturbo_N4p0LLN2LOUnsmoothed_N3pLLFixed_PdfAsFromN4LL", "FixedAlphaS", "N$^{4{+}0}$LL+N$^{2}$LO (Kenneth's N$^{4{+}0}$LL $#alpha_{s}$)"), # (no smth.)
        # ("scetlib_nnlojet_N4p0LLN3LOUnsmoothed_N3pLLFixed_PdfAsFromN4LL", "FixedAlphaS", "N$^{4{+}0}$LL+N$^{3}$LO (Kenneth's N$^{4{+}0}$LL $#alpha_{s}$)"), # (no smth.)

        # My own SCETlib files used to make as variations from N4LL
        # ("scetlib_dyturbo_N4p0LLN2LOUnsmoothed_N3pLLFixed_PdfAsFromN4LL_ResumSelf", "FixedAlphaS", "N$^{4{+}0}$LL+N$^{2}$LO (Arne's N$^{4{+}0}$LL $#alpha_{s}$)"), # (no smth.)
        # ("scetlib_nnlojet_N4p0LLN3LOUnsmoothed_N3pLLFixed_PdfAsFromN4LL_ResumSelf", "FixedAlphaS", "N$^{4{+}0}$LL+N$^{3}$LO (Arne's N$^{4{+}0}$LL $#alpha_{s}$)"), # (no smth.)
        # ("scetlib_dyturbo_N3p1LLN2LOUnsmoothed_N3pLLFixed_N2p1LLFixed_PdfAsFromN4LL_ResumSelf", "FixedAlphaS", "N$^{3{+}1}$LL+N$^{2}$LO (Arne's N$^{3{+}1}$LL $#alpha_{s}$)"), # (no smth.)
        # ("scetlib_nnlojet_N3p1LLN3LOUnsmoothed_N3pLLFixed_N2p1LLFixed_PdfAsFromN4LL_ResumSelf", "FixedAlphaS", "N$^{3{+}1}$LL+N$^{3}$LO (Arne's N$^{3{+}1}$LL $#alpha_{s}$)"), # (no smth.)

        # My own N3+0LL piece in "nominal" N3LL+NNLO -> Never ran this, corrections are identical on gen level
        # ("scetlib_dyturbo_ResumSelf", "FixedAlphaS", "N$^{3{+}0}$LL+NNLO (nominal)"),

        # ("scetlib_nnlojetN4p0LLN3LO", "SmoothFO_Kenneth_FixedAlphaS", "N$^{4{+}0}$LL+N$^{3}$LO (FO smth.)"), 
        # ("scetlib_nnlojet_N4p0LLN3LOSmoothRatio_N3pLLFixed", "FixedAlphaS", "N$^{4{+}0}$LL+N$^{3}$LO (ratio smth.)"), 
        # ("scetlib_nnlojetN3p1LLN3LOSmoothFO", "SmoothFO_Kenneth_FixedAlphaS", "N$^{3{+}1}$LL+N$^{3}$LO (FO smth.)"),
        # ("scetlib_nnlojet_N3p0LLN2LOUnsmoothed", "FixedAlphaS", "N$^{3}$LL+N$^{2}$LO (no smth.)"), 
        # ("scetlib_nnlojet_N3p0LLN2LOSmoothRatio", "FixedAlphaS", "N$^{3}$LL+N$^{2}$LO (raio smth.)"), 
    ...
    # corrs_and_postfixes_and_legendnames = [("scetlib_dyturbo_N4p0LLN2LOUnsmoothed_N3pLLFixed", "FixedAlphaS"), ("scetlib_dyturboN3p1LL", "N2LO_FixedAlphaS")]


    # modes = [Mode.mz_dilepton, Mode.mz_wlike, Mode.mwminus, Mode.mw]
    # modes = [Mode.mw, Mode.mz_wlike, Mode.mwminus, Mode.mz_dilepton]
    # modes = [Mode.mz_dilepton]
    # modes = [Mode.mz_wlike]
    # modes = [Mode.mwminus]
    # modes = [Mode.mw]
    # modes = [Mode.mz_dilepton, Mode.mz_wlike]
    # modes = [Mode.mz_wlike, Mode.mwminus]
    # modes = [Mode.mz_wlike_binnedscale]
    # modes = [Mode.mwminus_binnedscale]
    ...
    for mode in modes:
        for (theory_corr, postfix, legname) in corrs_and_postfixes_and_legendnames:
            ...
            # runner.print_mass_shift(add_theory_stat_unc=False)
            # runner.print_mass_shift(add_theory_stat_unc=True)
        
        # mass_summary_modeling(mode=mode, corrs_and_postfixes_and_legendnames=corrs_and_postfixes_and_legendnames, wremnants_folder=wremnants_folder, outfolder_base=outfolder_base, plotfolder_base=plotfolder_base, add_theory_stat_unc=False)
        # mass_summary_modeling(mode=mode, corrs_and_postfixes_and_legendnames=corrs_and_postfixes_and_legendnames, wremnants_folder=wremnants_folder, outfolder_base=outfolder_base, plotfolder_base=plotfolder_base, add_theory_stat_unc=True)
...
class Mode(Enum):
    mz_dilepton = "mz_dilepton"
    mz_wlike = "mz_wlike"
    mwminus = "mwminus"
    mw = "mw"
    mz_wlike_binnedscale = "mz_wlike_binnedscale"
    mwminus_binnedscale = "mwminus_binnedscale"
    as_dilepton = "as_dilepton"

mode_configs = {
    Mode.mz_dilepton: {
        "exec_histmaker": "mz_dilepton.py",
        "args_histmaker": " --originalPtBinning --axes yll ptll",
        "outputfile_histmaker": "mz_dilepton",
        "subfolder_histmaker": None,
        "args_setup_rabbit": " --fitvar ptll --axlim '0j' '54j'",
        "fitinput_folder": "ZMassDilepton_ptll",
        "fitinput_filename": "ZMassDilepton.hdf5",
        "args_unblind": "",
    },
    Mode.mz_wlike:{
        "exec_histmaker": "mz_wlike_with_mu_eta_pt.py",
        "args_histmaker": "",
        "outputfile_histmaker": "mz_wlike_with_mu_eta_pt",
        "subfolder_histmaker": None,
        "args_setup_rabbit": "",
        "fitinput_folder": "ZMassWLike_eta_pt_charge",
        "fitinput_filename": "ZMassWLike.hdf5",
        "args_unblind": " --unblind '.*'",
    },
    Mode.mwminus:{
        "exec_histmaker": "mw_with_mu_eta_pt.py",
        "args_histmaker": "",
        "outputfile_histmaker": "mw_with_mu_eta_pt",
        "subfolder_histmaker": None,
        "args_setup_rabbit": " --fitvar 'charge-pt-eta' --rebinBeforeSelection --axlim 0 1", # charge - is the first index in the charge axis, + is second
        "fitinput_folder": "WMass_charge_pt_eta",
        "fitinput_filename": "WMass.hdf5",
        "args_unblind": " --unblind '.*'",
    },
    Mode.mw:{
        "exec_histmaker": "mw_with_mu_eta_pt.py",
        ...
        "outputfile_histmaker": "mw_with_mu_eta_pt",
        "subfolder_histmaker": None,
        "args_setup_rabbit": " --fitvar 'charge-pt-eta' --rebinBeforeSelection",
        "fitinput_folder": "WMass_charge_pt_eta",
        "fitinput_filename": "WMass.hdf5",
        "args_unblind": " --unblind '.*'",
    },
    Mode.mz_wlike_binnedscale:{
        "exec_histmaker": "mz_wlike_with_mu_eta_pt.py",
        "args_histmaker": "",
        "outputfile_histmaker": "mz_wlike_with_mu_eta_pt",
        "subfolder_histmaker": None,
        "args_setup_rabbit": " --resumUnc 'scale'",
        "fitinput_folder": "ZMassWLike_eta_pt_charge",
        "fitinput_filename": "ZMassWLike.hdf5",
        "args_unblind": " --unblind '.*'",
    },
    Mode.mwminus_binnedscale:{
        "exec_histmaker": "mw_with_mu_eta_pt.py",
        "args_histmaker": "",
        "outputfile_histmaker": "mw_with_mu_eta_pt",
        "subfolder_histmaker": None,
        "args_setup_rabbit": " --resumUnc 'scale' --fitvar 'charge-pt-eta' --rebinBeforeSelection --axlim 0 1", # charge - is the first index in the charge axis, + is second
        "fitinput_folder": "WMass_charge_pt_eta",
        "fitinput_filename": "WMass.hdf5",
        "args_unblind": " --unblind '.*'",
    },
...
def make_postfix_plot(nominal_corr, postfix, add_theory_stat_unc, mode):
    ...
    if postfix:
        result += f"_{postfix}"
    if " --axlim 0 1" in mode_configs[mode]['args_setup_rabbit']:
        result += "_Wm"
...
class AnalysisRunner:
    ...
    def __post_init__(self):
        ...
        if self.mode in [Mode.mz_dilepton, Mode.mz_wlike, Mode.mz_wlike_binnedscale, Mode.as_dilepton]:
            # self.arg_pseudodata = f" --pseudoData '{self.nominal_corr}Corr'" if self.nominal_corr not in ["scetlib_dyturbo", "scetlib_dyturboN3p1LL"] else " --pseudoData 'uncorr'"
        ...
        elif self.mode in [Mode.mw, Mode.mwminus, Mode.mwminus_binnedscale]:
            self.arg_pseudodata = " --pseudoData 'uncorr'"
        # self.arg_pseudodata = " --pseudoData 'uncorr'"
    ...
    def run_setup_rabbit(self, add_theory_stat_unc=False):
        ...
        arg_postfix = self.postfix_fit_plot
        arg_theorystatunc = ""
        if self.mode in [Mode.mz_wlike_binnedscale, Mode.mwminus_binnedscale]:
            arg_postfix += "_BinnedScale"
        if self.mode in [Mode.as_dilepton]:
            arg_postfix += "_AlphaS"
        if " --axlim 0 1" in self.args_setup_rabbit:
            arg_postfix += "_Wm"
        if add_theory_stat_unc:
    ...
    def run_fit_rabbit(self, add_theory_stat_unc=False):
        ...
        command = f"{self.wremnants_folder}/rabbit/bin/rabbit_fit.py '{os.path.join(infolder, f'{self.fitinput_folder}_{arg_postfix}', self.fitinput_filename)}' --globalImpacts --computeHistErrors --saveHists --saveHistsPerProcess --doImpacts -t 0 --postfix data -o '{os.path.join(outfolder, f'{self.fitinput_folder}_{arg_postfix}')}'{self.args_unblind}"
    ...
    def plot_fit_rabbit(self, prefit=True, add_theory_stat_unc=False):
        ...
        # arg_rrange = "" if prefit or self.mode == Mode.mz_wlike else " --rrange 0.97 1.03" 

        postfix_fitresults_file = "asimov" if self.mode in [Mode.as_dilepton] else "data"
        # modelname = "Project" if self.mode in [Mode.as_dilepton] else "Basemodel"

        # modelname = "Basemodel"
        modelname = "Basemodel -m Project ch0 ptll"

        # arg_variations = " --varNames pdfAlphaS --varLabel '$\\alpha_\\mathrm{S}{\\pm}1\\sigma$'" if self.mode in [Mode.as_dilepton] else ""
        # arg_variations = " --varNames scetlibNPgamma --varLabel 'SCETLib $\\gamma$'" if self.mode in [Mode.as_dilepton] else ""
        ...
        command = f"{self.wremnants_folder}/rabbit/bin/rabbit_plot_hists.py --config utilities/styles/styles.py '{os.path.join(infolder, f'{self.fitinput_folder}_{arg_postfix}', f'fitresults_{postfix_fitresults_file}.hdf5')}'  --title CMS --titlePos 1 --subtitle WiP -o '{os.path.join(outfolder, f'{self.fitinput_folder}_{arg_postfix}')}' --legCols 1 --yscale 1.2{arg_prefit} --legCol 1 --legSize small -m {modelname}{arg_variations}{arg_nodata}{arg_rrange}"
        print(command)
        os.system(command)

    def print_mass_shift(self, add_theory_stat_unc=False):
        ...
        command = f"{self.wremnants_folder}/rabbit/bin/rabbit_print_pulls_and_constraints.py {os.path.join(self.outfolder_base, 'fitresults', f'{self.fitinput_folder}_{arg_postfix}', 'fitresults_data.hdf5')} | grep mass"
        print(command)
        os.system(command)
    ...
    def plot_impacts(self, add_theory_stat_unc=False):
        ...
        # pulls
        command = f"{self.wremnants_folder}/rabbit/bin/rabbit_plot_pulls_and_impacts.py '{os.path.join(infolder, f'{self.fitinput_folder}_{arg_postfix}', f'fitresults_{postfix_fitresults_file}.hdf5')}' --title CMS --subtitle WiP --postfix {arg_postfix} --showNumbers --diffPullAsym --pullrange '2.1' --config 'utilities/styles/styles.py' --oneSidedImpacts --grouping min --otherExtensions pdf png -n 50 --scaleImpacts {scaleimpacts} -o '{os.path.join(outfolder, f'{self.fitinput_folder}_{arg_postfix}')}' --noImpacts"
        print(command)
        os.system(command)
